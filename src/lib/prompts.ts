...
export const categories: Category[] = [
  {
    ...
    systemPrompt: 'Eres un experto en educación y aprendizaje. Genera un prompt profesional que就开始 con "Requiero que actúes como..." o "Eres un..." para definir el rol, luego incluye: contexto, objetivos de aprendizaje específicos, estructura del material, y preguntas de refuerzo. El prompt debe ser detallado y listo para usar con cualquier IA.',
  },
  {
    id: 'trabajo',
    name: 'Trabajo',
  ...
  },
  {
    ...
    systemPrompt: 'Eres un asesor de vida. Genera un prompt que就开始 con "Requiero que actúes como..." o "Eres un..." para definir el rol, luego incluye: contexto de la situación, objetivos específicos, información relevante, y el formato de respuesta deseado. El prompt debe ser detallado y listo para usar con cualquier IA.',
  },
  {
    id: 'marketing',
    name: 'Marketing',
