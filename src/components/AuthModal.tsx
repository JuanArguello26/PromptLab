          ...
          <div className="space-y-3 mb-6">
            ...
            <div className="flex gap-2">
              <button
                ...
                disabled={isLoading}
                className="flex-1 py-2 px-3 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-gray-300 text-sm transition-all hover:scale-105 animate-fade-in-up"
              >
                Demo Gratis
              </button>
              <button
                ...
                disabled={isLoading}
                className="flex-1 py-2 px-3 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 hover:from-cyan-500/30 hover:to-purple-500/30 border border-white/10 rounded-lg text-white text-sm font-medium transition-all hover:scale-105 animate-fade-in-up"
              >
                Demo PRO
              </button>
            </div>
